...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_FakeBass p_FakeBass;
        ...
        public static SteamVR_Input_ActionSet_FakeBass FakeBass
        {
            get
            {
                return SteamVR_Actions.p_FakeBass.GetCopy<SteamVR_Input_ActionSet_FakeBass>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_FakeBass = ((SteamVR_Input_ActionSet_FakeBass)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_FakeBass>("/actions/FakeBass")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.FakeBass};
        }
    }
}
